...
|[ISSR AI-Powered Funding Intelligence](https://github.com/PratikPawar1401/funding-intelligence)|Pratik Pawar|Automated pipeline that discovers, parses, and semantically tags federal funding opportunities (FOAs) for research development officers.|spaCy PhraseMatcher, Sentence-Transformers Embeddings, Mistral-7B LLM Disambiguation, FAISS Vector Search|[Click Here](https://github.com/PratikPawar1401/funding-intelligence)|[Click Here](https://medium.com/@pratikpawar1565/building-an-ai-powered-system-to-find-federal-research-funding-723cb2c34e8c)|
